...
class pbImage : public ::google::protobuf::Message {
 public:
  ...
  static const int kBayerEncodingFieldNumber = 16;
  ...
  static const int kColorEncodingFieldNumber = 17;
  ...
  inline const ::ladybug5_network::pbFloatTriblet& rotation() const;
  inline ::ladybug5_network::pbFloatTriblet* mutable_rotation();
  inline ::ladybug5_network::pbFloatTriblet* release_rotation();
  
  // optional .ladybug5_network.pbFloatTriblet translation = 19;
  inline bool has_translation() const;
  inline void clear_translation();
  static const int kTranslationFieldNumber = 19;
  inline const ::ladybug5_network::pbFloatTriblet& translation() const;
  inline ::ladybug5_network::pbFloatTriblet* mutable_translation();
  inline ::ladybug5_network::pbFloatTriblet* release_translation();
 ...
 private:
  ...
  ::ladybug5_network::pbFloatTriblet* rotation_;
  ::ladybug5_network::pbFloatTriblet* translation_;
...
inline void pbImage::set_type(ladybug5_network::ImageType value) {
  GOOGLE_DCHECK(ladybug5_network::ImageType_IsValid(value));
  set_has_type();
  type_ = value;
}
...
// optional .ladybug5_network.pbFloatTriblet rotation = 18;
inline bool pbImage::has_rotation() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void pbImage::set_has_rotation() {
  _has_bits_[0] |= 0x00000800u;
}
inline void pbImage::clear_has_rotation() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void pbImage::clear_rotation() {
  if (rotation_ != NULL) rotation_->::ladybug5_network::pbFloatTriblet::Clear();
  clear_has_rotation();
}
inline const ::ladybug5_network::pbFloatTriblet& pbImage::rotation() const {
  return rotation_ != NULL ? *rotation_ : *default_instance_->rotation_;
}
inline ::ladybug5_network::pbFloatTriblet* pbImage::mutable_rotation() {
  set_has_rotation();
  if (rotation_ == NULL) rotation_ = new ::ladybug5_network::pbFloatTriblet;
  return rotation_;
}
inline ::ladybug5_network::pbFloatTriblet* pbImage::release_rotation() {
  clear_has_rotation();
  ::ladybug5_network::pbFloatTriblet* temp = rotation_;
  rotation_ = NULL;
  return temp;
}

// optional .ladybug5_network.pbFloatTriblet translation = 19;
inline bool pbImage::has_translation() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void pbImage::set_has_translation() {
  _has_bits_[0] |= 0x00001000u;
}
inline void pbImage::clear_has_translation() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void pbImage::clear_translation() {
  if (translation_ != NULL) translation_->::ladybug5_network::pbFloatTriblet::Clear();
  clear_has_translation();
}
inline const ::ladybug5_network::pbFloatTriblet& pbImage::translation() const {
  return translation_ != NULL ? *translation_ : *default_instance_->translation_;
}
inline ::ladybug5_network::pbFloatTriblet* pbImage::mutable_translation() {
  set_has_translation();
  if (translation_ == NULL) translation_ = new ::ladybug5_network::pbFloatTriblet;
  return translation_;
}
inline ::ladybug5_network::pbFloatTriblet* pbImage::release_translation() {
  clear_has_translation();
  ::ladybug5_network::pbFloatTriblet* temp = translation_;
  translation_ = NULL;
  return temp;
}
